...
However, when Changjie is forcifully entered English mode through focusing on a password box (limited text scope), the IME is forcefully operate in English mode but continue to report conversion mode as 1 as Chinese mode.

## How to build

1. Fork this repository
2. Let the GitHub Actions run
3. The binaries will be built and upload as build artifact
